...
export default function Speakers() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] font-sans">
      ...
      <section className="max-w-[1110px] mx-auto px-6 lg:px-0 mt-[64px] md:mt-[120px] lg:mt-[160px] mb-[120px] md:mb-[120px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[32px] md:gap-[52px] lg:gap-[125px] items-center">
          <div className="relative w-full h-[352px] md:h-[352px] lg:h-[560px] bg-[#F1F1F1] rounded-lg overflow-hidden flex items-center justify-center">
            <div className="relative w-[180px] h-[220px] md:w-[280px] md:h-[320px] lg:w-[350px] lg:h-[420px]">
              <Image
                src="/Bitmap-4.png"
                alt="ZX9 Speaker"
                fill
      ...
      {/* ZX7 Speaker */}
      <section className="max-w-[1110px] mx-auto px-6 lg:px-0 mb-[120px] md:mb-[120px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[32px] md:gap-[52px] lg:gap-[125px] items-center">
          ...
          <div className="relative w-full h-[352px] md:h-[352px] lg:h-[560px] bg-[#F1F1F1] rounded-lg overflow-hidden order-1 lg:order-2 flex items-center justify-center">
            <div className="relative w-[180px] h-[220px] md:w-[280px] md:h-[320px] lg:w-[350px] lg:h-[420px]">
              <Image
                src="/Bitmap-12.jpg"
                alt="ZX7 Speaker"
